import CleanCSS from 'https://esm.sh/clean-css@4.2.3?no-check?target=deno'
import marked from 'https://esm.sh/marked@1.2.0?target=deno'
import postcss, { AcceptedPlugin } from 'https://esm.sh/postcss@8.1.4?target=deno'
import { minify } from 'https://esm.sh/terser@5.3.2?target=deno'
import { safeLoadFront } from 'https://esm.sh/yaml-front-matter@4.1.0?target=deno'
